...
const TR: SectionCopy = {
  ...
  about_paragraphs: [
    ...
    "Sonuç ölçülebilir ve tekrar üretilebilir: gerçek saldırı corpus'unda %100 recall, OWASP CRS ile %100 parity, %0.2 false positive, ~20 ms medyan ban gecikmesi ve 72 saatlik VM soak testinde 864 örnek boyunca 0 hata.",
  ...
  why_cards: [
    ...
    {
      title: "Dürüst sınır",
      body: "İlk isteği ModSec inline anında keser, biz reaktifiz; L3/L4'ü CDN absorb eder. Buna karşılık WAF/CRS hızımız aynı corpus'ta 16.93× ModSec.",
    },
    {
      title: "3'ü 1 arada",
...
const EN: SectionCopy = {
  ...
  about_paragraphs: [
    ...
    "Results are measurable and reproducible: 100% recall on real attack corpus, 100% OWASP CRS parity, 0.2% false positive, ~20 ms median ban latency and 0 errors over 864 samples in 72h VM soak.",
  ...
  about_highlights: [
    ...
    { k: "~20 ms", v: "median latency log line to ipset ban" },
  ...
  merge: [
    {
      ...
      body: "No separate Fail2ban. Log line to ipset/XDP kernel ban ~20 ms — policy, tenant, FP trust in one pipeline.",
      metrics: ["~20 ms median", "ipset + XDP", "0 fail (5 min)"],
    },
    {
      company: "ModSecurity",
      name: "WAF / CRS layer",
  ...
  metric_labels: {
    ...
    "Min örnek (21 ölçüm)": "Min sample (21 runs)",
    "Max örnek (21 ölçüm)": "Max sample (21 runs)",
    "Olay/sn parse (Core)": "Events/sec parse (Core)",
...
const SECTION_BODIES: Partial<Record<Locale, SectionBody>> = {
  de: {
    hero_side_body:
      "Eine Kette von der nginx-Access-Log-Zeile bis zum ipset-Ban: Parser, OWASP-CRS/WAF-Auswertung und ~20 ms Kernel-Ban. Rivalen bieten eine stückweise Architektur — wir vereinen alles in einer Kette mit gemessenem, reproduzierbarem PDF/JSON-Nachweis. In der Türkei entwickelt, MIT Open Source, voll self-hosted.",
    about_paragraphs: [
      ...
      "Die Ergebnisse sind messbar und reproduzierbar: 100% Recall auf echtem Angriffskorpus, 100% OWASP-CRS-Parität, 0,2% False Positives, ~20 ms mediane Ban-Latenz und 0 Fehler über 864 Proben im 72h-VM-Soak.",
    ...
    why_bodies: [
      "nginx-Log → OWASP CRS → ~20 ms Kernel-Ban. Kein Fail2ban + ModSec + Skript-Haufen.",
      ...
      "~20 ms medianer Ban — Fail2ban/CrowdSec in Sekunden–Minuten; 21 gemessene Proben.",
    ...
    merge_bodies: [
      "Kein separates Fail2ban. Logzeile bis ipset/XDP-Kernel-Ban ~20 ms — Policy, Tenant, FP-Trust in einer Pipeline.",
  ...
  fr: {
    hero_side_body:
      "Une seule chaîne de la ligne de log d'accès nginx au ban ipset : parser, évaluation OWASP CRS/WAF et ban noyau ~20 ms. Les rivaux offrent une architecture fragmentée — nous réunissons tout en une chaîne avec une preuve PDF/JSON mesurée et reproductible. Conçu en Turquie, open source MIT, entièrement auto-hébergé.",
    about_paragraphs: [
      ...
      "Les résultats sont mesurables et reproductibles : 100% de rappel sur un corpus d'attaques réelles, 100% de parité OWASP CRS, 0,2% de faux positifs, ~20 ms de latence de ban médiane et 0 erreur sur 864 échantillons lors du soak 72h en VM.",
    ...
    why_bodies: [
      ...
      "Ban médian ~20 ms — Fail2ban/CrowdSec en secondes–minutes ; 21 échantillons mesurés.",
  ...
  es: {
    hero_side_body:
      "Una sola cadena desde la línea de log de acceso de nginx hasta el ban de ipset: parser, evaluación OWASP CRS/WAF y ban de kernel ~20 ms. Los rivales ofrecen arquitectura fragmentada — nosotros unimos todo en una cadena con prueba PDF/JSON medida y reproducible. Desarrollado en Turquía, open source MIT, totalmente autoalojado.",
    about_paragraphs: [
      ...
      "Los resultados son medibles y reproducibles: 100% de recall en corpus de ataques reales, 100% de paridad OWASP CRS, 0,2% de falsos positivos, ~20 ms de latencia de ban mediana y 0 errores en 864 muestras durante el soak 72h en VM.",
    ...
    why_bodies: [
      "log de nginx → OWASP CRS → ban de kernel ~20 ms. Sin montón de Fail2ban + ModSec + scripts.",
      ...
      "Ban mediano ~20 ms — Fail2ban/CrowdSec en segundos–minutos; 21 muestras medidas.",
    ...
    merge_bodies: [
      "Sin Fail2ban aparte. De la línea de log al ban de kernel ipset/XDP ~20 ms — policy, tenant, FP trust en un pipeline.",
  ...
  ru: {
    hero_side_body:
      "Одна цепочка от строки access-лога nginx до бана ipset: парсер, оценка OWASP CRS/WAF и бан в ядре ~20 мс. Конкуренты предлагают фрагментарную архитектуру — мы объединяем всё в одну цепочку с измеренным, воспроизводимым доказательством PDF/JSON. Разработано в Турции, открытый код MIT, полностью self-hosted.",
    about_paragraphs: [
      ...
      "Результаты измеримы и воспроизводимы: 100% recall на корпусе реальных атак, 100% паритет OWASP CRS, 0,2% ложных срабатываний, ~20 мс медианной задержки бана и 0 ошибок на 864 образцах за 72-часовой soak на ВМ.",
    ...
    why_bodies: [
      "лог nginx → OWASP CRS → бан в ядре ~20 мс. Без груды Fail2ban + ModSec + скриптов.",
      ...
      "Медианный бан ~20 мс — Fail2ban/CrowdSec в секундах–минутах; 21 измеренных образцов.",
    ...
    merge_bodies: [
      "Без отдельного Fail2ban. От строки лога до бана в ядре ipset/XDP ~20 мс — policy, tenant, FP trust в одном пайплайне.",
  ...
  pt: {
    hero_side_body:
      "Uma só cadeia da linha de log de acesso do nginx ao ban de ipset: parser, avaliação OWASP CRS/WAF e ban de kernel ~20 ms. Os rivais oferecem arquitetura fragmentada — juntamos tudo numa cadeia com prova PDF/JSON medida e reproduzível. Feito na Turquia, open source MIT, totalmente self-hosted.",
    about_paragraphs: [
      ...
      "Os resultados são mensuráveis e reproduzíveis: 100% de recall no corpus de ataques reais, 100% de paridade OWASP CRS, 0,2% de falsos positivos, ~20 ms de latência de ban mediana e 0 erros em 864 amostras no soak 72h em VM.",
    ...
    why_bodies: [
      ...
      "Ban mediano ~20 ms — Fail2ban/CrowdSec em segundos–minutos; 21 amostras medidas.",
  ...
  nl: {
    hero_side_body:
      "Eén keten van de nginx-accesslogregel tot de ipset-ban: parser, OWASP-CRS/WAF-evaluatie en kernel-ban ~20 ms. Concurrenten bieden een versnipperde architectuur — wij voegen alles samen in één keten met gemeten, reproduceerbaar PDF/JSON-bewijs. Gemaakt in Turkije, MIT open source, volledig self-hosted.",
    about_paragraphs: [
      ...
      "De resultaten zijn meetbaar en reproduceerbaar: 100% recall op een corpus van echte aanvallen, 100% OWASP-CRS-pariteit, 0,2% false positives, ~20 ms mediane ban-latency en 0 fouten over 864 monsters in de 72h-VM-soak.",
    ...
    why_bodies: [
      ...
      "Mediane ban ~20 ms — Fail2ban/CrowdSec in seconden–minuten; 21 gemeten monsters.",
  ...
  zh: {
    hero_side_body:
      "从 nginx 访问日志行到 ipset 封禁的单一链路：解析器、OWASP CRS/WAF 评估和约 20 毫秒内核封禁。竞品提供零散架构——我们用实测、可复现的 PDF/JSON 证据将一切合并到一条链路中。土耳其制造，MIT 开源，完全自托管。",
    about_paragraphs: [
      ...
      "结果可衡量、可复现：真实攻击语料 100% 召回、100% OWASP CRS 对等、0.2% 误报、约 20 毫秒中位封禁延迟，以及 72 小时 VM soak 中 864 个样本 0 错误。",
      "本站是公开的落地与下载页面——静态内容。软件运行在你自己的 Linux 服务器上；数据留在你手中。",
    ],
    pkg_hero:
      "无需分别安装 Fail2ban、ModSecurity 和 CrowdSec，Log Guardian 将三者合并到一个自托管软件包中。",
    why_bodies: [
      "nginx 日志 → OWASP CRS → 约 20 毫秒内核封禁。没有 Fail2ban + ModSec + 脚本堆。",
      ...
      "中位封禁约 20 毫秒——Fail2ban/CrowdSec 在秒—分钟级；21 个实测样本。",
      "JA3 集群 100% 召回——80 IP 实测；按 IP 封禁 + 集群检测。",
      "Telegram 告警 + 一键 ack、SOC 时间线、租户指标——安装后 :8443。",
    ],
    merge_bodies: [
      "无需单独的 Fail2ban。从日志行到 ipset/XDP 内核封禁约 20 毫秒——策略、租户、FP trust 于一条流水线。",
  ...
  ja: {
    hero_side_body:
      "nginx アクセスログの行から ipset BAN までの単一チェーン：パーサー、OWASP CRS/WAF 評価、約20msのカーネルBAN。競合は断片的なアーキテクチャを提供します——私たちは実測・再現可能な PDF/JSON の証拠とともに一本のチェーンに統合します。トルコ製、MIT オープンソース、完全セルフホスト。",
    about_paragraphs: [
      ...
      "結果は測定可能で再現可能です：実攻撃コーパスでリコール100%、OWASP CRS 100%整合、誤検知0.2%、中央値 約20msのBANレイテンシ、72時間 VM ソークで864サンプル中0エラー。",
    ...
    why_bodies: [
      "nginx ログ → OWASP CRS → 約20msのカーネルBAN。Fail2ban + ModSec + スクリプトの山は不要。",
      ...
      "中央値BAN 約20ms——Fail2ban/CrowdSec は秒〜分単位；21件の実測サンプル。",
      "JA3 クラスタ リコール100%——80 IP のライブテスト；IP ごとの BAN + クラスタ検知。",
      "Telegram アラート + ワンクリック ack、SOC タイムライン、テナントメトリクス——導入後 :8443。",
    ],
    merge_bodies: [
      "個別の Fail2ban は不要。ログ行から ipset/XDP カーネルBANまで約20ms——ポリシー、テナント、FP trust が1本のパイプラインに。",
  ...
  ko: {
    hero_side_body:
      "nginx 액세스 로그 라인에서 ipset 밴까지의 단일 체인: 파서, OWASP CRS/WAF 평가, 약 20ms 커널 밴. 경쟁사는 조각난 아키텍처를 제공합니다 — 우리는 측정되고 재현 가능한 PDF/JSON 증거와 함께 모든 것을 하나의 체인으로 통합합니다. 튀르키예 제작, MIT 오픈소스, 완전 셀프호스팅.",
    about_paragraphs: [
      ...
      "결과는 측정 가능하고 재현 가능합니다: 실제 공격 코퍼스에서 재현율 100%, OWASP CRS 100% 동등성, 오탐 0.2%, 중앙값 약 20ms 밴 지연, 72시간 VM soak에서 864 샘플 중 0 오류.",
    ...
    why_bodies: [
      "nginx 로그 → OWASP CRS → 약 20ms 커널 밴. Fail2ban + ModSec + 스크립트 더미 없음.",
      ...
      "중앙값 밴 약 20ms — Fail2ban/CrowdSec은 초~분 단위; 21개 측정 샘플.",
      "JA3 클러스터 재현율 100% — 80 IP 실시간 테스트; IP별 밴 + 클러스터 탐지.",
      "Telegram 알림 + 원클릭 ack, SOC 타임라인, 테넌트 메트릭 — 설치 후 :8443.",
    ],
    merge_bodies: [
      "별도 Fail2ban 없음. 로그 라인에서 ipset/XDP 커널 밴까지 약 20ms — 정책, 테넌트, FP trust가 하나의 파이프라인에.",
  ...
  az: {
    hero_side_body:
      "nginx giriş log sətrindən ipset bana qədər tək zəncir: parser, OWASP CRS/WAF qiymətləndirməsi və ~20 ms kernel ban. Rəqiblər parçalı memarlıq təklif edir — biz hər şeyi ölçülmüş, təkrar istehsal edilə bilən PDF/JSON sübutu ilə bir zəncirdə birləşdiririk. Türkiyədə hazırlanıb, MIT açıq mənbə, tam self-hosted.",
    about_paragraphs: [
      ...
      "Nəticələr ölçülə bilən və təkrar istehsal edilə biləndir: real hücum korpusunda 100% recall, 100% OWASP CRS pariteti, 0.2% yanlış pozitiv, ~20 ms median ban gecikməsi və 72 saat VM soak-da 864 nümunədə 0 xəta.",
    ...
    why_bodies: [
      ...
      "Median ban ~20 ms — Fail2ban/CrowdSec saniyə–dəqiqə səviyyəsində; 21 ölçülmüş nümunə.",
  ...
  kk: {
    hero_side_body:
      "nginx кіру лог жолынан ipset банға дейін бір тізбек: parser, OWASP CRS/WAF бағалауы және ~20 мс kernel ban. Бәсекелестер бөлшек архитектура ұсынады — біз бәрін өлшенген, қайта жаңғыртылатын PDF/JSON дәлелімен бір тізбекте біріктіреміз. Түркияда жасалған, MIT ашық код, толық self-hosted.",
    about_paragraphs: [
      ...
      "Нәтижелер өлшенеді және қайта жаңғыртылады: нақты шабуыл корпусында recall 100%, OWASP CRS паритеті 100%, 0.2% жалған позитив, ~20 мс медиана бан кідірісі және 72 сағат VM soak ішінде 864 үлгіде 0 қате.",
    ...
    why_bodies: [
      "nginx логы → OWASP CRS → ~20 мс kernel ban. Fail2ban + ModSec + скрипт үйіндісі жоқ.",
      ...
      "CDN L3/L4-ті сіңіреді. Origin-де интеграция + жылдамдық.",
      "Fail2ban, ModSecurity, CrowdSec бөлек емес — ban + WAF + SOC бір өнімде.",
      "Медиана бан ~20 мс — Fail2ban/CrowdSec секунд–минут деңгейінде; 21 өлшенген үлгі.",
    ...
    merge_bodies: [
      "Бөлек Fail2ban жоқ. Лог жолынан ipset/XDP kernel банға ~20 мс — саясат, tenant, FP trust бір pipeline-да.",
  ...
  uz: {
    hero_side_body:
      "nginx kirish log qatoridan ipset banga qadar yagona zanjir: parser, OWASP CRS/WAF baholash va ~20 ms kernel ban. Raqiblar bo'lak arxitektura taklif qiladi — biz hammasini o'lchangan, qayta ishlab chiqariladigan PDF/JSON dalil bilan bitta zanjirda birlashtiramiz. Turkiyada ishlab chiqilgan, MIT ochiq kod, to'liq self-hosted.",
    about_paragraphs: [
      ...
      "Natijalar o'lchanadigan va qayta ishlab chiqariladigan: haqiqiy hujum korpusida recall 100%, OWASP CRS pariteti 100%, 0.2% noto'g'ri pozitiv, ~20 ms median ban kechikishi va 72 soat VM soak'da 864 namunada 0 xato.",
    ...
    why_bodies: [
      ...
      "Median ban ~20 ms — Fail2ban/CrowdSec soniya–daqiqa darajasida; 21 o'lchangan namuna.",
  ...
  ky: {
    hero_side_body:
      "nginx кирүү лог сабынан ipset банга чейин бирдиктүү чынжыр: parser, OWASP CRS/WAF баалоо жана ~20 мс kernel ban. Атаандаштар бөлүк архитектура сунуштайт — биз баарын өлчөнгөн, кайра чыгарылуучу PDF/JSON далили менен бир чынжырда бириктиребиз. Түркияда жасалган, MIT ачык код, толук self-hosted.",
    about_paragraphs: [
      ...
      "Натыйжалар өлчөнөт жана кайра чыгарылат: чыныгы чабуул корпусунда recall 100%, OWASP CRS паритети 100%, 0.2% жалган позитив, ~20 мс медиана бан кечигүүсү жана 72 саат VM soak ичинде 864 үлгүдө 0 ката.",
    ...
    why_bodies: [
      "nginx логу → OWASP CRS → ~20 мс kernel ban. Fail2ban + ModSec + скрипт үймөгү жок.",
      ...
      "CDN L3/L4'ту сиңирет. Origin'де интеграция + ылдамдык.",
      "Fail2ban, ModSecurity, CrowdSec өзүнчө эмес — ban + WAF + SOC бир продуктта.",
      "Медиана бан ~20 мс — Fail2ban/CrowdSec секунд–мүнөт деңгээлинде; 21 өлчөнгөн үлгү.",
    ...
    merge_bodies: [
      "Өзүнчө Fail2ban жок. Лог сабынан ipset/XDP kernel банга ~20 мс — саясат, tenant, FP trust бир pipeline'да.",
  ...
  tk: {
    hero_side_body:
      "nginx giriş log setirinden ipset bana çenli ýeke zynjyr: parser, OWASP CRS/WAF bahalandyrma we ~20 ms kernel ban. Bäsdeşler bölek arhitektura hödürleýär — biz hemmesini ölçelen, gaýtadan öndürilýän PDF/JSON subutnamasy bilen bir zynjyrda birleşdirýäris. Türkiýede öndürilen, MIT açyk çeşme, doly self-hosted.",
    about_paragraphs: [
      ...
      "Netijeler ölçäp bolýan we gaýtadan öndürilýän: hakyky hüjüm korpusynda recall 100%, OWASP CRS pariteti 100%, 0.2% ýalňyş pozitiw, ~20 ms mediana ban gijikdirmesi we 72 sagat VM soak-da 864 nusgada 0 ýalňyşlyk.",
    ...
    why_bodies: [
      ...
      "Mediana ban ~20 ms — Fail2ban/CrowdSec sekunt–minut derejesinde; 5 ölçelen nusga.",
  ...
  tt: {
    hero_side_body:
      "nginx керү лог юлыннан ipset банга кадәр бер чылбыр: parser, OWASP CRS/WAF бәяләү һәм ~20 мс kernel ban. Көндәшләр өлешле архитектура тәкъдим итә — без барысын да үлчәнгән, кабат җитештерелә торган PDF/JSON дәлиле белән бер чылбырда берләштерәбез. Төркиядә ясалган, MIT ачык код, тулысынча self-hosted.",
    about_paragraphs: [
      ...
      "Нәтиҗәләр үлчәнә һәм кабат җитештерелә: чын һөҗүм корпусында recall 100%, OWASP CRS паритеты 100%, 0.2% ялган позитив, ~20 мс медиана бан тоткарлыгы һәм 72 сәгать VM soak эчендә 864 үрнәктә 0 хата.",
    ...
    why_bodies: [
      "nginx логы → OWASP CRS → ~20 мс kernel ban. Fail2ban + ModSec + скрипт өеме юк.",
      ...
      "CDN L3/L4'ны сеңдерә. Origin'да интеграция + тизлек.",
      "Fail2ban, ModSecurity, CrowdSec аерым түгел — ban + WAF + SOC бер продуктта.",
      "Медиана бан ~20 мс — Fail2ban/CrowdSec секунд–минут дәрәҗәсендә; 5 үлчәнгән үрнәк.",
    ...
    merge_bodies: [
      "Аерым Fail2ban юк. Лог юлыннан ipset/XDP kernel банга ~20 мс — сәясәт, tenant, FP trust бер pipeline'да.",
  ...
  ba: {
    hero_side_body:
      "nginx инеү лог юлынан ipset банға тиклем бер сылбыр: parser, OWASP CRS/WAF баһалау һәм ~20 мс kernel ban. Көндәштәр өлөшлө архитектура тәҡдим итә — беҙ барыһын да үлсәнгән, ҡабат етештерелә торған PDF/JSON дәлиле менән бер сылбырҙа берләштерәбеҙ. Төркиәлә яһалған, MIT асыҡ код, тулыһынса self-hosted.",
    about_paragraphs: [
      ...
      "Һөҙөмтәләр үлсәнә һәм ҡабат етештерелә: ысын һөжүм корпусында recall 100%, OWASP CRS паритеты 100%, 0.2% ялған позитив, ~20 мс медиана бан тотҡарлығы һәм 72 сәғәт VM soak эсендә 864 өлгөлә 0 хата.",
    ...
    why_bodies: [
      "nginx логы → OWASP CRS → ~20 мс kernel ban. Fail2ban + ModSec + скрипт өйөмө юҡ.",
      ...
      "CDN L3/L4'ты һеңдерә. Origin'да интеграция + тиҙлек.",
      "Fail2ban, ModSecurity, CrowdSec айырым түгел — ban + WAF + SOC бер продуктта.",
      "Медиана бан ~20 мс — Fail2ban/CrowdSec секунд–минут кимәлендә; 5 үлсәнгән өлгө.",
    ...
    merge_bodies: [
      "Айырым Fail2ban юҡ. Лог юлынан ipset/XDP kernel банға ~20 мс — сәйәсәт, tenant, FP trust бер pipeline'да.",
  ...
  cv: {
    hero_side_body:
      "nginx кӗрӳ лог йӗркинчен ipset бана ҫитиччен пӗр сӑнчӑр: parser, OWASP CRS/WAF хаклани тата ~20 мс kernel бан. Конкурентсем татӑк-татӑк архитектура сӗнеҫҫӗ — эпир пурне те виҫнӗ, тепӗр хут тӑвакан PDF/JSON кӑтартупа пӗр сӑнчӑрта пӗрлештеретпӗр. Турцире тунӑ, MIT уҫӑ код, пӗтӗмпех self-hosted.",
    about_paragraphs: [
      ...
      "Результатсем виҫме тата тепӗр хут тума пулаҫҫӗ: чӑн тапӑну корпусӗнче recall 100%, OWASP CRS паритечӗ 100%, 0.2% суя позитив, ~20 мс медиана бан кӗтӗвӗ тата 72 сехет VM soak ӑшӗнче 864 тӗслӗхре 0 йӑнӑш.",
    ...
    why_bodies: [
      "nginx логӗ → OWASP CRS → ~20 мс kernel бан. Fail2ban + ModSec + скрипт купи ҫук.",
      ...
      "CDN L3/L4-а ҫӑтать. Origin ҫинче интеграци + хӑвӑртлӑх.",
      "Fail2ban, ModSecurity, CrowdSec уйрӑм мар — бан + WAF + SOC пӗр продуктра.",
      "Медиана бан ~20 мс — Fail2ban/CrowdSec ҫекунт–минут шайӗнче; 5 виҫнӗ тӗслӗх.",
    ...
    merge_bodies: [
      "Уйрӑм Fail2ban ҫук. Лог йӗркинчен ipset/XDP kernel бана ~20 мс — политика, tenant, FP trust пӗр pipeline-ра.",
  ...
  crh: {
    hero_side_body:
      "nginx kirim log satırından ipset banğa qadar tek zıncır: parser, OWASP CRS/WAF qıymetlendirüv ve ~20 ms kernel ban. Raqipler parça-parça mimarlıq teklif ete — biz episini ölçengen, tekrar tüzülgen PDF/JSON delilnen tek zıncırda birleştiremiz. Türkiyede yapılğan, MIT açıq kod, tamamen self-hosted.",
    about_paragraphs: [
      ...
      "Neticeler ölçele bile ve tekrar tüzüle bile: kerçek hücum korpusında recall 100%, OWASP CRS pariteti 100%, 0.2% yañlış pozitiv, ~20 ms mediana ban keçikmesi ve 72 saat VM soak içinde 864 örnekte 0 hata.",
    ...
    why_bodies: [
      ...
      "Mediana ban ~20 ms — Fail2ban/CrowdSec saniye–daqiqa seviyesinde; 5 ölçengen örnek.",
  ...
  gag: {
    hero_side_body:
      "nginx giriş log satırından ipset bana kadar tek zincir: parser, OWASP CRS/WAF diişilmesi hem ~20 ms kernel ban. Rakiplär parça-parça mimarlık verer — biz hepsini ölçülü, tekrar yapılabilän PDF/JSON delillän tek zincirdä birleştireriz. Türkiyedä yapıldı, MIT açık kod, bütünnä self-hosted.",
    about_paragraphs: [
      ...
      "Sonuçlar ölçülebilir hem tekrar yapılabilir: gerçek saldırı korpusunda recall 100%, OWASP CRS pariteti 100%, 0.2% yalancı pozitiv, ~20 ms mediana ban gecikmesi hem 72 saat VM soak içindä 864 örnektä 0 hata.",
    ...
    why_bodies: [
      ...
      "Mediana ban ~20 ms — Fail2ban/CrowdSec saniye–dakika kertindä; 5 ölçülü örnek.",
  ...
  ug: {
    hero_side_body:
      "nginx كىرىش خاتىرە قۇرىدىن ipset چەكلەشكىچە بىرلا زەنجىر: parser، OWASP CRS/WAF باھالاش ۋە ~20 مىللىسېكۇنت يادرو چەكلىشى. رەقىبلەر پارچە قۇرۇلما تەمىنلەيدۇ — بىز ھەممىنى ئۆلچەنگەن، قايتا ياسىغىلى بولىدىغان PDF/JSON ئىسپاتى بىلەن بىرلا زەنجىرگە بىرلەشتۈرىمىز. تۈركىيەدە ياسالغان، MIT ئوچۇق كود، تولۇق self-hosted.",
    about_paragraphs: [
      ...
      "نەتىجىلەر ئۆلچىگىلى ۋە قايتا ياسىغىلى بولىدۇ: ھەقىقىي ھۇجۇم كورپۇسىدا recall 100%، OWASP CRS تەڭپۇڭلۇقى 100%، 0.2% يالغان مۇسبەت، ~20 مىللىسېكۇنت ئوتتۇرا چەكلەش كېچىكىشى ۋە 72 سائەت VM soak ئىچىدە 864 نەمۇنىدە 0 خاتالىق.",
    ...
    why_bodies: [
      "nginx خاتىرىسى → OWASP CRS → ~20 مىللىسېكۇنت يادرو چەكلىشى. Fail2ban + ModSec + skript دۆۋىسى يوق.",
      ...
      "CDN L3/L4 نى سىڭدۈرىدۇ. Origin دا بىرلەشتۈرۈش + سۈرئەت.",
      "Fail2ban، ModSecurity، CrowdSec ئايرىم ئەمەس — چەكلەش + WAF + SOC بىر مەھسۇلاتتا.",
      "ئوتتۇرا چەكلەش ~20 مىللىسېكۇنت — Fail2ban/CrowdSec سېكۇنت–مىنۇت دەرىجىسىدە؛ 21 ئۆلچەنگەن نەمۇنە.",
    ...
    merge_bodies: [
      "ئايرىم Fail2ban يوق. خاتىرە قۇرىدىن ipset/XDP يادرو چەكلىشىگە ~20 مىللىسېكۇنت — سىياسەت، tenant، FP trust بىر quburدا.",
  ...
  sah: {
    hero_side_body:
      "nginx киирии лог строкатыттан ipset баҥҥа тиийэ биир сиэп: parser, OWASP CRS/WAF сыаналааһын уонна ~20 мс kernel бан. Күрэхтэһээччилэр аҥаардас архитектураны тэлэллэр — биһиги барытын кээмэйдэммит, хат оҥоһуллар PDF/JSON туоһунан биир сиэпкэ холбуубут. Турцияҕа оҥоһуллубут, MIT аһаҕас код, толору self-hosted.",
    about_paragraphs: [
      ...
      "Түмүктэр кээмэйдэнэллэр уонна хат оҥоһуллаллар: чахчы саба түһүү корпуһугар recall 100%, OWASP CRS паритета 100%, 0.2% сымыйа позитив, ~20 мс медиана бан хойутааһына уонна 72 чаас VM soak иһигэр 864 холобурга 0 алҕас.",
    ...
    why_bodies: [
      "nginx лога → OWASP CRS → ~20 мс kernel бан. Fail2ban + ModSec + скрипт бөҕө суох.",
      ...
      "CDN L3/L4-у ыҥырар. Origin-га интеграция + түргэн.",
      "Fail2ban, ModSecurity, CrowdSec туспа буолбатах — бан + WAF + SOC биир бородууксуйаҕа.",
      "Медиана бан ~20 мс — Fail2ban/CrowdSec сөкүүндэ–мүнүөтэ таһымыгар; 5 кээмэйдэммит холобур.",
    ...
    merge_bodies: [
      "Туспа Fail2ban суох. Лог строкатыттан ipset/XDP kernel баҥҥа ~20 мс — политика, tenant, FP trust биир pipeline-га.",
