...
const I18N = {
  "tr": {
    ...
    "tests.teaser": "Dashboard ile aynı otomatik test matrisi — <strong>75 kanıt</strong> (kurulum kapıları, CRS, FP, ban gecikmesi, corpus, 72h soak).",
    "tests.open_full": "Tüm testleri gör (75)",
  ...
  "en": {
    ...
    "tests.teaser": "Same automated test matrix as the dashboard — <strong>75 proofs</strong> (install gates, CRS, FP, ban latency, corpus, 72h soak).",
    "tests.open_full": "View all tests (75)",
    ...
    "showcase.core.tag2": "OWASP CRS",
    "showcase.core.eyebrow": "//:Core",
    "showcase.core.title": "Core — log to ban",
    "showcase.core.desc": "Single chain: nginx log → OWASP CRS → ~17 ms kernel ban. Production-ready in ~15 minutes.",
    "showcase.pro.short": "SOC",
    "showcase.pro.peek": "Fleet · SOC timeline",
    "showcase.pro.tag1": "Fleet",
    "showcase.pro.tag2": "Timeline",
    "showcase.pro.eyebrow": "//:Pro",
    "showcase.pro.title": "Pro — SOC & fleet",
    "showcase.pro.desc": "Fleet, SOC timeline, Grafana — optional layer on your server after install.",
    "showcase.proof.short": "PROOF",
    "showcase.proof.peek": "73 tests ·      72h soak PASS",
    "showcase.proof.tag1": "73 tests",
    "showcase.proof.tag2": "72h soak",
    "showcase.proof.eyebrow": "//:Proof",
    "showcase.proof.title": "Proof — 75 tests",
    "showcase.proof.desc": "75 automated tests, competitive PDF, 72h soak — same matrix as dashboard /tests.",
    "showcase.grafana.short": "METRICS",
    "showcase.grafana.peek": "Prometheus · tenant alerts",
    "showcase.grafana.tag1": "Prometheus",
    "showcase.grafana.tag2": "Alerts",
    "showcase.grafana.eyebrow": "//:Metrics",
    "showcase.grafana.title": "Metrics — Grafana",
