...
export function TestsPageClient({ proofMeta, buildRev }: Props) {
  const { t } = useLanguage();
  ...
  return (
    <div className="min-h-screen p-6 md:p-8 max-w-7xl mx-auto flex flex-col gap-6">
      <header className="glass-panel p-6 border-b border-white/10 flex items-center gap-4">
        ...
        <div className="flex items-start gap-3 min-w-0 flex-1">
          ...
          <div className="min-w-0">
            ...
            {proofMeta && proofMeta.expected > 0 && (
              <p
                className="text-[11px] font-mono text-cyan-400/75 mt-2"
                data-lg-proof={proofMeta.expected}
              >
                competitive-proof {proofMeta.passed}/{proofMeta.expected}
      ...
      <ValidationTestsPanel compact={false} proofMeta={proofMeta} />
