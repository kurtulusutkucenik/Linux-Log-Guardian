    ...
    <div className="p-8 space-y-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <span className="text-slate-400 hidden sm:inline">Push: BAN_IP / PUSH_CONFIG / PUSH_WAF_RULE</span>
          <Radio className={`w-4 h-4 ${online > 0 ? 'text-green-400 animate-pulse' : 'text-slate-500'}`} />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl h-fit">
          <h2 className="text-xl font-semibold mb-6 flex items-center text-white">
            <Terminal className="w-5 h-5 mr-2 text-indigo-400" /> {t('fleetDispatchForm')}
          </h2>
          ...
          <form onSubmit={handleSendCommand} className="space-y-4">
            ...
            >
              ...
              {submitting ? 'Dispatching...' : t('fleetDispatchSend')}
            </button>
          </form>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <h2 className="text-xl font-semibold flex items-center text-white">
            <Command className="w-5 h-5 mr-2 text-slate-400" /> {t('fleetDispatchHistory')}
          </h2>
