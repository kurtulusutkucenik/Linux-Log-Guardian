...
export const GRAFANA_SOC_STAT_PANELS: GrafanaStatPanel[] = [
  ...
  { id: "ban_events_db", title: "ban_events DB rows", expr: 'loganalyzer_ban_events_total{tenant_id="$tenant"}' },
  { id: "intel_ban_legacy", title: "Intel ban legacy", expr: 'loganalyzer_intel_ban_legacy_rows{tenant_id="$tenant"}' },
  { id: "intel_ban_summary", title: "Intel ban summary", expr: 'loganalyzer_intel_ban_summary_rows{tenant_id="$tenant"}' },
