...
export LOGANALYZER_DISCORD_WEBHOOK_URL="${LOGANALYZER_DISCORD_WEBHOOK_URL:-https://discord.com/api/webhooks/000000000000000000/FAKE_TOKEN}"
export LOGANALYZER_SLACK_WEBHOOK_URL="${LOGANALYZER_SLACK_WEBHOOK_URL:-https://hooks.slack.com/services/T00/B00/FAKE}"
